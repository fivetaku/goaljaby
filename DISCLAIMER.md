# Disclaimer & Acceptable Use — goaljaby

`goaljaby` is part of the [gptaku-plugins](https://github.com/fivetaku/gptaku_plugins)
...
`goaljaby` is a general-purpose developer tool. Like most general-purpose tools, it
